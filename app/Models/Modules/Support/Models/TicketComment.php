...
class TicketComment extends Model
{
    ...
    public function getAuthorTypeColorAttribute(): string
    {
    ...
    public function getAuthorTypeIconAttribute(): string
    {
        return match($this->author_type) {
