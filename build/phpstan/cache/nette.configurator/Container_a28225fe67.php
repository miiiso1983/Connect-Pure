...
class Container_a28225fe67 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService045(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'/Users/mustafaaljaf/Documents/augment-projects/Connect Pure/vendor/nunomaduro/larastan/extension.neon',
			],
			null,
			[
				...
				'/Users/mustafaaljaf/Documents/augment-projects/Connect Pure/vendor/nunomaduro/larastan/bootstrap.php',
			],
			null,
			'5'
		);
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a28225fe67 $container)
			{
	...
	public function createServiceContainer(): Container_a28225fe67
	{
		return $this;
	}
