...
class Container_f30ca03c0b extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_f30ca03c0b $container)
			{
	...
	public function createServiceContainer(): Container_f30ca03c0b
	{
		return $this;
	}
