...
@section('title', __('accounting.bulk_upload_vendors'))
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">{{ __('accounting.bulk_upload_vendors') }}</h1>
            <p class="text-gray-600 mt-1">{{ __('accounting.upload_multiple_vendors_excel') }}</p>
        </div>
        <div class="flex space-x-3 {{ app()->getLocale() === 'ar' ? 'space-x-reverse' : '' }}">
            <a href="{{ route('modules.accounting.vendors.index') }}" class="btn-secondary">
                {{ __('accounting.back_to_vendors') }}
            </a>
            <a href="{{ route('modules.accounting.vendors.download-template') }}" class="btn-outline">
    ...
    <x-card title="{{ __('accounting.upload_file') }}">
        <form action="{{ route('modules.accounting.vendors.process-bulk-upload') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        <td class="px-3 py-2 text-sm text-gray-900">ABC Supplies</td>
                        <td class="px-3 py-2 text-sm text-gray-900">ABC Supplies Inc.</td>
                        <td class="px-3 py-2 text-sm text-gray-900">contact@abcsupplies.com</td>
                    ...
                    <tr class="bg-gray-50">
                        <td class="px-3 py-2 text-sm text-gray-900">XYZ Materials</td>
                        <td class="px-3 py-2 text-sm text-gray-900">XYZ Materials Ltd</td>
                        <td class="px-3 py-2 text-sm text-gray-900">info@xyzmaterials.com</td>
